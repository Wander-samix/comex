...
public class TesteClassePedido {
    public static void main(String[] args) {
        ...
        // Exibindo informações dos pedidos de forma segura
        pedidos.forEach(pedido -> {
            if (pedido.getCliente() != null) {
                System.out.println("Pedido ID: " + pedido.getId() + ", Cliente: " + pedido.getCliente().getNome() +
                        ", Preço: " + pedido.getPreco() + ", Quantidade: " + pedido.getQuantidade() +
                        ", Valor Total: " + pedido.getValorTotal());
            } else {
                System.out.println("Pedido ID: " + pedido.getId() + " tem um cliente nulo!");
            }
        });
    }
}
