...
public class TesteProduto {
    public static void main(String[] args) {
        ...
        BigDecimal precoUnitario = BigDecimal.valueOf(scanner.nextDouble());

        System.out.println("Por favor, insira a quantidade do produto:");
        int quantidade = scanner.nextInt();

        System.out.println("Por favor, insira a categoria do produto:");
        int categoria = scanner.nextInt();

        // Criação do objeto Produto com dados fornecidos pelo usuário
        Produto produto = new Produto(nome, descricao, precoUnitario, quantidade, categoria);
